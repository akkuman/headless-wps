...
apt update && apt install -y wget bsdmainutils xdg-utils libxslt1.1 xvfb && wget https://wps-linux-personal.wpscdn.cn/wps/download/ep/Linux2019/11698/wps-office_11.1.0.11698_amd64.deb && apt install -y ./wps-office_11.1.0.11698_amd64.deb
